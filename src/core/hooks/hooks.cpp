...
bool Hooks::init() {
    ...
    Log::log(LOG, " Hooking ShouldDrawCrosshair...");
    ShouldDrawCrosshair::original = (ShouldDrawCrosshair::func)VMT::hook(Interfaces::clientMode, (void *)ShouldDrawCrosshair::hook, 29);
...
bool Hooks::unload() {
    ...
    Log::log(LOG, " Unhooking ShouldDrawCrosshair...");
    VMT::hook(Interfaces::clientMode, (void *)ShouldDrawCrosshair::original, 29);
