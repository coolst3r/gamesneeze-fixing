...
namespace Hooks {
    ...
    namespace CreateMove {
        using func = bool(*)(void *thisptr, float flInputSampleTime, Command* cmd);
        inline func original;
        bool hook(void *thisptr, float flInputSampleTime, Command* cmd);
    }
    namespace Paint {
    ...
    namespace DrawModelExecute {
        using func = void(*)(void *thisptr, void *ctx, const DrawModelState_t &state, const ModelRenderInfo_t &pInfo, Matrix3x4 *pCustomBoneToWorld);
        inline func original;
        void hook(void *thisptr, void *ctx, const DrawModelState_t &state, const ModelRenderInfo_t &pInfo, Matrix3x4 *pCustomBoneToWorld);
    }
