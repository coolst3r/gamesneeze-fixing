...
enum class AntiAimState {
		Freestanding,
		Walking,
		InAir,
};

inline const char *render_anti_aim_state(AntiAimState anti_aim_state) noexcept {
		switch (anti_aim_state) {
				case AntiAimState::Freestanding: {
					return "freestanding";
					break;
				}
				case AntiAimState::Walking: {
					return "walking";
					break;
				}
				case AntiAimState::InAir: {
					return "in air";
					break;
				}
		}
...
inline float jitter_for_anti_aim_state(AntiAimState anti_aim_state) noexcept {
		switch (anti_aim_state) {
				case AntiAimState::Freestanding: {
					return 14.0f;
					break;
...
inline int fake_lag_for_anti_aim_state(AntiAimState anti_aim_state) noexcept {
		switch (anti_aim_state) {
				case AntiAimState::Freestanding: {
					return 2;
					break;
...
public:
	...
	float minYaw;
	float maxYaw;
	char unkown[52];// Overall Size should be 0x3B0(+4), padding the end here.
};//Size: 0x0178
